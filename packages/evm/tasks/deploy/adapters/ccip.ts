...
task("deploy:adapter:CCIPAdapter")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, ccipAdapter, constructorArguments)
  })
...
task("deploy:adapter:CCIPHeaderReporter")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, ccipHeaderReporter, constructorArguments)
  })
...
task("deploy:adapter:CCIPMessageRelay")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, ccipMessageRelay, constructorArguments)
  })
