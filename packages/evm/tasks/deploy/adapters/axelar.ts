...
task("deploy:adapter:AxelarAdapter")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, axelarAdapter, constructorArguments)
  })
...
task("deploy:adapter:AxelarHeaderReporter")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, axelarHeaderReporter, constructorArguments)
  })
...
task("deploy:adapter:AxelarMessageRelay")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, axelarMessageRelay, constructorArguments)
  })
