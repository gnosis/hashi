...
task("deploy:adapter:LayerZeroAdapter")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, layerZeroAdapter)
  })
...
task("deploy:adapter:LayerZeroHeaderReporter")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, layerZeroHeaderReporter)
  })
...
task("deploy:adapter:LayerZeroMessageRelay")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, layerZeroMessageRelay)
  })
