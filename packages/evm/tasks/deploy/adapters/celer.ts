...
task("deploy:adapter:CelerAdapter")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, celerAdapter)
  })
...
task("deploy:adapter:CelerHeaderReporter")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, celerHeaderReporter)
  })
...
task("deploy:adapter:CelerMessageRelay")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, celerMessageRelay)
  })
