...
task("deploy:adapter:ZetaAdapter")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, zetaAdapter, constructorArguments)
  })
...
task("deploy:adapter:ZetaHeaderReporter")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, zetaHeaderReporter, constructorArguments)
  })
...
task("deploy:adapter:ZetaMessageRelay")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, zetaMessageRelay, constructorArguments)
  })
