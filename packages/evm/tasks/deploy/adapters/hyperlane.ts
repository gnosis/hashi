...
task("deploy:adapter:HyperlaneAdapter")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, hyperlaneAdapter, constructorArguments)
  })
...
task("deploy:adapter:HyperlaneHeaderReporter")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, hyperlaneHeaderReporter, constructorArguments)
  })
...
task("deploy:adapter:HyperlaneMessageRelay")
  ...
  .setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    if (taskArguments.verify) await verify(hre, hyperlaneMessageRelay, constructorArguments)
  })
