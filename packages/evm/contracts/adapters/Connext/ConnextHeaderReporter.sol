...
contract ConnextHeaderReporter {
    ...
    constructor(IConnext _connext, HeaderStorage _headerStorage, address _target) {
        connext = _connext;
    ...
    function reportHeader(uint256 blockNumber, uint256 toChainId) public returns (bytes32 transferId) {
        ...
        transferId = connext.xcall{ value: 0 }(
            uint32(toChainId), // _destination: Domain ID of the destination chain
