...
import ABI from "../ABIs/CCIPReporterContractABI.json" assert { type: "json" }

import BaseController from "./BaseController.js"

import { BaseControllerConfigs } from "./BaseController.js"

class CCIPReporterController extends BaseController {
  constructor(_configs: BaseControllerConfigs) {
    super(_configs, "CCIPReporterController")
  }
...
export default CCIPReporterController
